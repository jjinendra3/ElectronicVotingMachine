...
{   
    ...
    printf("********************************************************************************\n");
    printf("*                                   *                                          *\n");
    printf("*       NAME                        *         ENROLLEMENT   NUMBER             *\n");
    printf("*                                   *                                          *\n");
    printf("********************************************************************************\n");
    printf("*                                   *                                          *\n");
...
int loading()   
{
    ...
    printf("please wait loading program\n");
    printf("loading ");
...
MainMenuTextLabel:
    ...
    else if (mainMenuOption == 4)
    {
        ...
        printf("\033[1;32m");
            printf("Welcome Lakshya Kandpal!\nPlease Enter your Password:");
            printf("\033[0m");
        gets(c);
        if(!(strcmp(c,"h"))){
             check++;
    ...
    printf("BTECH\n\n");
        ...
        printf("VOTE PERCENT:%0.2f",(float)arrforbtech[i]*100/totalvotesbtech); 
        printf("%c\n\n",37); 
        printf("\033[0m");  
        }
        ...
        printf("PERCENTAGE OF BTECH VOTERS ARE:%f%c\n\n",(float)totalvotesbtech*100/totalregistrations,37);
        printf("\033[0m");
        // FOR BTECH END
        printf("BBA\n\n");
        // FOR BBA START
        ...
        printf("VOTE PERCENT:%0.2f",(float)arrforbba[i]*100/totalvotesbba); 
        printf("%c\n\n",37);   
        printf("\033[0m");
        }
        ...
        printf("PERCENTAGE OF BBA VOTERS ARE:%f%c\n\n",(float)totalvotesbba*100/totalregistrations,37);
        printf("\033[0m");
        //FOR BBA END

        // TOTAL TURN OUT AND PARTY WON
        printf("TOTAL VOTES IN COLLEGE\n");
        for(int i=0;i<NumberOfParty;i++){
            if(arrforres[i]==0){
                continue;
            }
        ...
        printf("VOTER TURNOUT:%0.2f",(float)arrforres[i]*100/totalvotes); 
        printf("%c\n\n",37);   
        printf("\033[0m");
        }
        ...
        printf("TOTAL VOTER TURNOUT:%f%c\n",(float)totalvotes*100/totalregistrations,37);
        printf("\033[0m");
